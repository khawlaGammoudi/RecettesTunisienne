<%-- 
    Document   : SupprimerRecettes
    Created on : 17 janv. 2015, 14:19:12
...
<html>
<head>
<title>Recettes.com | Supprimer Recettes</title>
<meta charset="utf-8">
      ...
      <div class="wrapper">
        ...
        <nav>
          <ul class="menu">
            ...
            <li><a  class="active" href="SupprimerRecettes.jsp">Supprimer Recettes</a></li>
...
<section id="content">
  <div class="main">
    <div class="wrapper">
      ...
      <article class="col-2">
        <h3 class="p1">Supprimer  Recettes</h3>
            ...
            <%
                ...
                <td>
                    <form action="./suppression"  method="POST">
                        ...
                        <input class="button-2" type="submit" value="Supprimer" />
                    </form>
